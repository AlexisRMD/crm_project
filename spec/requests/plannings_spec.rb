...
RSpec.describe "/plannings", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Planning.create! valid_attributes
      get plannings_url
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Planning" do
        expect {
          post plannings_url, params: { planning: valid_attributes }
        }.to change(Planning, :count).by(1)
      end

      it "redirects to the created planning" do
        post plannings_url, params: { planning: valid_attributes }
        expect(response).to redirect_to(planning_url(Planning.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Planning" do
        expect {
          post plannings_url, params: { planning: invalid_attributes }
        }.to change(Planning, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested planning" do
        planning = Planning.create! valid_attributes
        patch planning_url(planning), params: { planning: new_attributes }
        planning.reload
      ...
      it "redirects to the planning" do
        ...
        patch planning_url(planning), params: { planning: new_attributes }
        planning.reload
        expect(response).to redirect_to(planning_url(planning))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        planning = Planning.create! valid_attributes
        patch planning_url(planning), params: { planning: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
  ...
  describe "DELETE /destroy" do
    ...
    it "redirects to the plannings list" do
      planning = Planning.create! valid_attributes
      delete planning_url(planning)
      expect(response).to redirect_to(plannings_url)
    end
  end
end
